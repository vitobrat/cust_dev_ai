...
INTERVIEW_SIMULATION_RECURSION_LIMIT = 80
INTERVIEW_ORCHESTRATOR_RECURSION_LIMIT = 120
INTERVIEW_ORCHESTRATOR_MAX_BATCH_SIZE = 10
INTERVIEW_PERSONA_PROMPT_SAMPLE_SIZE = 3
INTERVIEW_PERSONA_PROMPT_FIELD_LIMIT = 180
FINAL_REPORT_MAX_INTERVIEW_SESSIONS = 50
FINAL_REPORT_GENERATION_RECURSION_LIMIT = 20
FINAL_REPORT_PROMPT_FIELD_LIMIT = 500
FINAL_REPORT_PROMPT_LIST_LIMIT = 6
