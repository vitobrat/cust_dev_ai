...
async def test_generate_persona_attribute_updates_state(
    ...
    result = await generate_single_persona_graph._generate_persona_attribute(generate_persona_state)
    ...
    assert result["demographic_attributes"] == persona
...
async def test_generate_persona_biography_creates_narrative(
    ...
    result = await generate_single_persona_graph._generate_persona_biography(generate_persona_state)
    ...
    assert result["biography"] == "Generated biography text"
...
async def test_generate_persona_biography_validates_attribute_type(
    ...
    generate_persona_state["demographic_attributes"] = "invalid type"
...
async def test_generate_persona_experiences_creates_narrative(
    ...
    result = await generate_single_persona_graph._generate_persona_experiences(generate_persona_state)
    ...
    assert result["experiences"] == "Generated experiences text"
...
async def test_format_output_combines_all_components(
    ...
    result = await generate_single_persona_graph._format_output(generate_persona_state)

    assert "personas" in result
    assert len(result["personas"]) == 1
    persona_output = result["personas"][0]
